<template>
  <div class="container-fluid">
    ...
    <div class="row">
      <div
        class="col-sm-12 col-md-4 col-lg-3 col-xl-2 mt-2 mx-auto text-center"
      >
        <a class="text-decoration-none" href="mailto:carlosarroyoam@gmail.com">
          <button type="button" class="btn btn-primary btn-block px-4">
            <span class="d-flex align-items-center justify-content-center">
              Enviar un email
              <svg class="svg-icon ml-3" viewBox="0 0 512 512">
                <path
    ...
    <div class="row">
      <div
        class="col-sm-12 col-md-6 col-lg-5 col-xl-4 mt-5 mx-auto social-links-container"
      >
        <nuxt-link
          tag="a"
          :to="localePath({ name: 'contactme-resume' })"
          class="social-button-container text-decoration-none"
        >
        ...
        >
          <div class="social-button">
            <svg class="social-icon ml-1" viewBox="0 0 512 512">
              <path
